...
<form action="userInfo.jsp" method="post">
    <table>
        <tr><td>User Name</td><td><input type="text" name="username" value="Mahesh" /></td></tr>
        <tr><td>Password</td><td><input type="password" name="password" value="12345" /></td></tr>
        <tr><td>Address</td>
            <td><textarea name="address" rows="4" cols="25">Sample Address</textarea></td>
        </tr>
        <tr>
