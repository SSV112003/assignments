...
public class QNO49 {
    ...
    public static void main(String[] args) {
        Employee49 emp1 = new Employee49("Vishwas", Optional.of("vishwas@example.com"), Optional.of("HR"));
        Employee49 emp2 = new Employee49("Ranjith", Optional.empty(), Optional.empty());
