...
/* OUTPUT
1. Books with price > 100:
Java Book (Books, ₹250.0)
Python Book (Books, ₹180.0)

2. Orders with at least one Baby product:
Order{id=201, status='Shipped', orderDate=2021-02-05, deliveryDate=2021-02-10, customer=Bob}
Order{id=204, status='Delivered', orderDate=2021-02-20, deliveryDate=2021-02-25, customer=Bob}
...
4. Products ordered by Tier 2 customers between Feb–Apr 2021:
Java Book (Books, ₹250.0)
Baby Diaper (Baby, ₹75.0)
Toy Car (Toys, ₹150.0)
C++ Book (Books, ₹90.0)
Python Book (Books, ₹180.0)
Baby Powder (Baby, ₹120.0)

5. Cheapest book:
C++ Book (Books, ₹90.0)

6. 3 most recent orders:
Order{id=203, status='Pending', orderDate=2021-04-01, deliveryDate=2021-04-05, customer=Alice}
Order{id=202, status='Delivered', orderDate=2021-03-15, deliveryDate=2021-03-18, customer=Charlie}
Order{id=204, status='Delivered', orderDate=2021-02-20, deliveryDate=2021-02-25, customer=Bob}
...
9. Most expensive product by category:
Toys => Soft Toy (Toys, ₹200.0)
Baby => Baby Powder (Baby, ₹120.0)
Books => Java Book (Books, ₹250.0)
*/
